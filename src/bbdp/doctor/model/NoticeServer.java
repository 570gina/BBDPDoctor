...
public class NoticeServer {
	//新增醫生注意事項
	public static String addNoticeItem(Connection conn, String doctorID, String type ,String content){
	...
	//新增注意事項給病患
	public static String addPatientNotice(Connection conn, String time, String patientID, String doctorID, String content){
		PreparedStatement statement = null;

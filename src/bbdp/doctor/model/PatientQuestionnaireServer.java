...
public class PatientQuestionnaireServer {
	public static int newPatientQuestionnaire(DataSource datasource,Connection conn, String doctorID, String patientID, String questionnaireID, String times, String cycleType, String totalTimes, String today) {
	...
	public static String newAnswer(Connection conn, String doctorID, String patientID, String answerID, String questionnaireID, String doctorAnswer, String selfDescription) {
		int tempInt = 0;
		String returnString = "";
